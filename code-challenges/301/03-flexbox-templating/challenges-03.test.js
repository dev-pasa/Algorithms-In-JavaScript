...
//   let getArray = a => Array.isArray(a) ? a : [a];
//   let order = (a, b) => a > b ? [a, b] : [b, a];
//  let  sort = (a, b) => getArray(a).reduce((r, v) => r.concat(order(r.pop(), v)), [b]);
//   return(arr.reduce(sort))
// };

const sortBackwards = (arr) => {
  // let nums = [];
  // // let sort = arr.sort = (a,b) => b - a;
  // let backWard = arr.sort(function (a, b) {  return b - a;  });
  // nums.push(backWard);
  // return nums;
...
const sortPeople = (arr) => {
  return arr.sort((a,b) => (a.lastName > b.lastName) ? 1 : ((b.lastName > a.lastName) ? -1 : 0)); 
...
// basically check for the most specific case first 
...
const sortMeetingsByDay = (arr) => {
  const weekDaySorter = {
   ...
   return arr.sort( (a, b) => {
    ...
    return weekDaySorter[day1] > weekDaySorter[day2];
  });
};
